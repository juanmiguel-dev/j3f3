              ...
              <div className="relative bg-zinc-950 border border-zinc-800/50 rounded-2xl p-6 md:p-8 shadow-2xl">
                ...
                <Calendar
                  ...
                  classNames={{
                    ...
                    head_row: "table-row",
                    head_cell: "text-zinc-500 font-bold text-xs uppercase tracking-widest h-10 w-10 table-cell align-middle text-center",
                    row: "table-row",
                    cell: "h-14 w-14 table-cell align-middle text-center p-0 relative focus-within:relative focus-within:z-20",
                    day: cn(
