  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-zinc-400 rounded-md flex-1 font-normal text-[0.8rem]",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-white hover:bg-zinc-700 hover:text-white"
        ),
